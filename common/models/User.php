...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules(): array
    {
        return [
            ['username', 'trim'],
            ['username', 'required'],
            ['username', 'unique', 'targetClass' => self::class, 'filter' => $this->isNewRecord ? [] : ['not', ['id' => $this->id]], 'message' => 'Bu username band.'],
            ...
            ['email', 'unique', 'targetClass' => self::class, 'filter' => $this->isNewRecord ? [] : ['not', ['id' => $this->id]], 'message' => 'Bu email band.'],
    ...
    /**
     * Foydalanuvchi administrator ekanligini tekshirish
     */
    ...
    public function beforeSave($insert): bool
    {
        ...
        } elseif ($insert && empty($this->auth_key)) {
            $this->generateAuthKey();
        }
